...
DEFAULT_TEMPLATE_DATA = {
    ...
    'tenancy_terms': {
        ...
        'caution_fee': {
            ...
            'currency': 'NGN',
            'type': 'Refundable',
            'deducted_for': '<ol><li>Cost of anything damaged or repaired in the demised premises by the tenant</li></ol>',
            'refunded_if': '<ol><li>Tenant confirmed by landlord to have not damaged anything in the premises</li></ol>',
            'top_up': '<ol><li>Where caution fee is insufficient, tenant shall complete the balance</li></ol>',
        },
    },
